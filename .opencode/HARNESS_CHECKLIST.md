...
- [ ] F/E is built and artifacts are served through B/E with verification evidence
- [ ] Completed trades (`open -> close`) trigger Telegram notifications when enabled
- [ ] Settings includes Telegram notification `on/off` and behavior is verified
